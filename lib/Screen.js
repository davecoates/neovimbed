...
export default class Screen {
    ...
    getModifiedRows() {
        ...
        if (this.modifiedRange) {
            ...
            let lastLineNumber = Number(this.cells[lastIndex].slice(0, this.lineNumberColumns).join(''));
            if (Number.isNaN(lastLineNumber)) {
                lastLineNumber = firstLineNumber + rows.length;
            }
